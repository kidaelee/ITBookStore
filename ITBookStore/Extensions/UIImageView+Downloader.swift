...
struct DefaultImageDownloader: ImageDownloaderable {
    static var shared: DefaultImageDownloader = DefaultImageDownloader()
...
extension UIImageView {
    ...
    func setImage(with url: String, imageDownloader: ImageDownloaderable? = DefaultImageDownloader.shared) {
        cancelImageRequest()
        self.image = nil
